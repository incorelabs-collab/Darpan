        ...
        if(k>0) {
            for(var i=0;i<k;i++) {
                ...
                if((resultsID[i] - 10000) > 0) {
                    searchConcatString += "<div class='row singleMemberImgAndData'><div class='col-xs-6 singleMemberImgData'><img src='img/DP/"+resultsID[i]+".jpg' class='img-responsive' onerror='pageSearchResults.imgError(this)'></div><div class='col-xs-6 singleData'>";
